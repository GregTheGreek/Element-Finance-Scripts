...
import { CRV_WITHDRAWAL_TRANSACTIONS } from './constants';
...
async function proposal() {
  ...
  for (let i in CRV_WITHDRAWAL_TRANSACTIONS) {
    const treasuryCallData = treasuryVotingInterface.encodeFunctionData('genericCall', [
        CRV_WITHDRAWAL_TRANSACTIONS[i].to,
        CRV_WITHDRAWAL_TRANSACTIONS[i].data
    ]);
