...
export interface ZapSwapCurveInterface extends ethers.utils.Interface {
  functions: {
...
export interface ZapSwapCurve extends BaseContract {
  ...
  functions: {
    ...
    "setApprovalsFor(address[],address[],uint256[])"(
      tokens: string[],
      spenders: string[],
      amounts: BigNumberish[],
      overrides?: Overrides & { from?: string | Promise<string> }
    ...
    "zapIn((bytes32,address,address,uint256,uint256,bool),(address,address,uint256[],address[],uint256,uint256),(address,address,uint256[],address[],uint256,uint256),(address,address,uint256,uint256,bytes32,bytes32,uint8)[])"(
      _info: ZapInInfoStruct,
      _zap: ZapCurveLpInStruct,
      _childZap: ZapCurveLpInStruct,
      _permitData: PermitDataStruct[],
    ...
    "zapOut((bytes32,address,uint256,address,uint256,uint256,uint256,bool),(address,address,int128,address,bool),(address,address,int128,address,bool),(address,address,uint256,uint256,bytes32,bytes32,uint8)[])"(
      _info: ZapOutInfoStruct,
      _zap: ZapCurveLpOutStruct,
      _childZap: ZapCurveLpOutStruct,
      _permitData: PermitDataStruct[],
