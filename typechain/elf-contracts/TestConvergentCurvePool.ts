...
export interface TestConvergentCurvePoolInterface
...
export interface TestConvergentCurvePool extends BaseContract {
  ...
  functions: {
    ...
    "burnLP(uint256,uint256[],address)"(
      lpBurn: BigNumberish,
      currentBalances: BigNumberish[],
      source: string,
      overrides?: Overrides & { from?: string | Promise<string> }
  ...
  "pausers(address)"(arg0: string, overrides?: CallOverrides): Promise<boolean>;
